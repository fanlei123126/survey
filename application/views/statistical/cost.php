<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            ...
            <!--                    <input type="text" class="form-control" id="real_name" placeholder="请输入真实姓名" autocomplete="off" />-->
            <!--                </div>-->
            <!---->
            ...
            <!--                <button type="button" id="btn_add" class="btn btn-primary">新增账户</button>-->
            <!--            </div>-->
            ...
            var TableInit = function() {
                ...
                oTableInit.Init = function() {
                    $('#table').bootstrapTable({
                        url: '<?php echo $ajax_url; ?>/get_cost',// 请求后台的URL（ * ）
                        method: 'post', //请求方式（*）
                        ...
                        columns: [{
                            ...
                            field: 'payment_expenses',
                            title: '付款项'
                        },{
                            field: 'payment_expenses_code',
                            title: '费用付款账号'
                        }, {
                            field: 'payee',
                            title: '收款人'
                        }, {
                            field: 'reimbursement_person',
                            title: '报销人'
                        },    {
                            field: 'monthly_cost_total_price',
                            title: '月度物流费合计'
                        }, {
                            field: 'remark',
                            title: '备注'
                ...
                oTableInit.queryParams = function(params) {
                    var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
                        ...
                        payment_expenses: $("#payment_expenses").val(),
                        payment_expenses_code: $("#payment_expenses_code").val(),
                        payee: $("#payee").val(),
                        reimbursement_person: $("#reimbursement person").val(),
                        monthly_cost_total_price: $("#monthly_cost_total_price").val(),
                        remark: $("#remark").val(),
                    };
