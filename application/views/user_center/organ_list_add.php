...
<div class="ibox-content">
    <form class="form-horizontal m-t" id="ff">
            ...
            <div class="col-sm-8">
                <select name="organ_type" id="organ_type" class="form-control">
                    ...
                    <?php foreach($organTypeList as $organType){?>
                        <option value="<?php echo $organType['organ_type_id']?>"><?php echo $organType['organ_type_name']?></option>
                    <?php }?>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="internal" name="internal" class="form-control" type="text" />
            </div>
        </div>
        <div class="form-group">
...
<script>
    ...
    $("#ff").validate({
        ...
        submitHandler: function(form){
            ...
            $(form).ajaxSubmit({
                type: 'post',
                url: '<?php echo $ajax_url?>/create_organ',
                dataType: 'json',
