<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        ...
        <script>
            ...
            var TableInit = function() {
                ...
                oTableInit.Init = function() {
                    $('#table').bootstrapTable({
                        url: '<?php echo $ajax_url; ?>/get_project_payment_order_list',// 请求后台的URL（ * ）
                        method: 'post', //请求方式（*）
            ...
            var ButtonInit = function() {
                ...
                oInit.Init = function() {
                    ...
                    $('#btn_add').on('click', function() {
                        window.location.href =  '<?php echo $page_url;?>/update';
                    });
            ...
            function update(id){
                //iframe窗
                window.location.href =  '<?php echo $page_url;?>/audit';
            }
