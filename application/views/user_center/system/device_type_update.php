...
<div class="ibox-content">
    <form class="form-horizontal m-t" id="ff">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="name" name="name" class="form-control" type="text" value="<?php echo $data['device_type_name'];?>" />
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-12" style="text-align: center;">
                <input type="hidden" name="id" value="<?php echo $data['device_type_id'];?>" />
...
<script>
    ...
    $("#ff").validate({
        ...
        submitHandler: function(form){
            ...
            $(form).ajaxSubmit({
                type: 'post',
                url: '<?php echo $ajax_url?>/device_type_update',
                dataType: 'json',
