...
<div class="ibox-content">
    <form class="form-horizontal m-t" id="ff">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="online_time" readonly name="online_time" class="form-control layer-date" type="text" placeholder="点击选择上线日期"  />
...
<script>
    ...
    $("#ff").validate({
        ...
        submitHandler: function(form){
            ...
            $(form).ajaxSubmit({
                type: 'post',
                url: '<?php echo $ajax_url?>/create_version',
                dataType: 'json',
