        ...
        <div class="ibox-content">
            <form id="formSearch" class="form-inline form-box">
                <div class="form-group">
                    <label for="real_name">供应商姓名：</label>
            ...
            <div id="toolbar" class="btn-group ">
                <button type="button" id="btn_add" class="btn btn-primary">新增供货商</button>
    ...
    var TableInit = function() {
        ...
        oTableInit.Init = function() {
            $('#table').bootstrapTable({
                url: '<?php echo $ajax_url; ?>/get_supplier_list',// 请求后台的URL（ * ）
                method: 'post', //请求方式（*）
        ...
        oTableInit.queryParams = function(params) {
            var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
                ...
                payment_order: $("#payment_order").val(),
                mobile: $("#mobile").val(),
