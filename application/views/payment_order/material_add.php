...
<div class="ibox-content">
    <form class="form-horizontal m-t" id="ff">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input disabled id="realname" name="realname" class="form-control" type="text" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    <input type="text" disabled class="form-control" id="organ_name" name="organ_name" placeholder="供应商名称" />
