...
<div class="ibox-content">
    <form class="form-horizontal m-t" id="ff">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span class="span-red">*</span>供应商姓名：</label>
            <div class="col-sm-8">
                <input id="realname" name="realname" class="form-control" type="text" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><span class="span-red">*</span>付款账户：</label>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label">老板姓名：</label>
            <div class="col-sm-8">
