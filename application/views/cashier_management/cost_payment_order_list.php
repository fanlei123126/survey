        ...
        <div class="ibox-content">
            <form id="formSearch" class="form-inline form-box">
                <div class="form-group">
                    <label for="real_name">项目号：</label>
                    <input type="text" class="form-control" id="real_name" placeholder="请输入项目号" autocomplete="off" />
                </div>
            ...
            <div id="toolbar" class="btn-group ">
                <button type="button" id="btn_add" class="btn btn-primary">新增付款单</button>
            </div>
            ...
            var TableInit = function() {
                ...
                oTableInit.Init = function() {
                    $('#table').bootstrapTable({
                        url: '<?php echo $ajax_url; ?>/get_cost_payment_order_list',// 请求后台的URL（ * ）
                        method: 'post', //请求方式（*）
                        ...
                        columns: [{
                            ...
                            formatter: function(value,row,index){
                                var a = '';
                                a += '<a href="javascript:void(0)" onclick="update(' + value + ')" class="btn btn-info"><i class="fa fa-paste"></i>审核</a>';
                                return a;
                            }
                        }]
                    });
