...
<!--                --><?php //}?>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span class="span-red">*</span>供应商：</label>
            <div class="col-sm-8">
                <select id="device_type" name="device_type"  class="form-control">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span class="span-red">*</span>产品名：</label>
            <div class="col-sm-8">
                <select id="device_type" name="device_type"  class="form-control">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span class="span-red">*</span>客户名：</label>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span class="span-red">*</span>金额(元)：</label>
            <div class="col-sm-8">
                <input id="product_unit" name="product_unit" class="form-control" type="text" />
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-12" style="text-align: center;">
                <span style="color:red">* 注：如有垫付，需填写供应商联系人，电话及付款凭证
                </span>
            </div>
        </div>
        <div class="form-group">
