...
//     * @name 获得一个(创建了目录)新文件
//     */
//    function get_newfilename($filetype='')
//    {
//        $filetype = $filetype ? $filetype : $this->type;
//        //生成新图片路径
//        $file1 = substr(md5(time()), 0, 2);
//        $file2 = substr(md5(time()), -2);
//        $path = FILE_BASE_DIR.'/'.$file1.'/'.$file2.'/';
//        if(!file_exists($path))
//        { 
//            @mkdir(FILE_BASE_DIR.'/'.$file1);
//            @mkdir($path);
//        }        
//        
//        $target_file = '/'.$file1.'/'.$file2.'/'.date("YmdHis").rand( 1 ,10000 ).'.'.$filetype;
//        return $target_file;
//    }
}