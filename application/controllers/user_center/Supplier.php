...
class Supplier extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->data['page_url'] = BASE_SITE_URL."/user_center/supplier/";
    ...
    */
    function index($pageType="list", $id=0){
        switch($pageType) {
            case 'list':
                display('user_center/supplier_list', $this->data);
                break;
            case 'add':
             //   $this->data['systemList'] = $this->system_list_model->getAllSystemList();
                display('user_center/supplier_list_add', $this->data);
                break;
            case 'update':
                if(!$id){
                    $heading = "数据获取失败-1";
                    ...
                    if (!$accountInfo) {
                        ...
                        display('user_center/supplier_list_update', $this->data);
                    }
                }
                break;
            case 'system_rule':
