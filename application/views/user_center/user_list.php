    ...
    var TableInit = function() {
        ...
        oTableInit.Init = function() {
            $('#table').bootstrapTable({
                url: '<?php echo $ajax_url; ?>/get_account_list',// 请求后台的URL（ * ）
                method: 'post', //请求方式（*）
                ...
                columns: [{
                    ...
                    formatter: function(value,row,index){
                        ...
                        a += '<a href="javascript:void(0)" onclick="reset(' + value + ')" class="btn btn-warning"><i class="fa fa-undo"></i>密码重置</a>';
                        a += '<a href="javascript:void(0)" onclick="viewrule(' + value + ')" class="btn btn-info"><i class="fa fa-info"></i>更改角色</a>';
                        return a;
                    }
                }]
            });
