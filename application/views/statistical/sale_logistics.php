            ...
            var TableInit = function() {
                ...
                oTableInit.Init = function() {
                    $('#table').bootstrapTable({
                        url: '<?php echo $ajax_url; ?>/get_sale_logistics',// 请求后台的URL（ * ）
                        method: 'post', //请求方式（*）
                        ...
                        columns: [{
                            ...
                            field: 'monthly_logistics_total_price',
                            title: '月度物流费合计'
                        },  {
                            field: 'sale_price',
                            title: '销售单价元/件'
                ...
                oTableInit.queryParams = function(params) {
                    var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
                        ...
                        logistics_name: $("#logistics_name").val(),
                        signed_by: $("#signed_by").val(),
                        product_code: $("#product_code").val(),
                        issued_quantity: $("#issued_quantity").val(),
                        coast_price: $("#coast_price").val(),
                        logistics_price: $("#logistics_price").val(),
                        monthly_logistics_total_price: $("#monthly_logistics_total_price").val(),
                        sale_price: $("#sale_price").val(),
                        sale_total_price: $("#sale_total_price").val(),
                        single_profit: $("#single_profit").val(),
                        remark: $("#remark").val(),
                    };
                    return temp;
                };
