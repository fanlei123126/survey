...
<!--                --><?php //}?>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span class="span-red">*</span>报销人：</label>
            <div class="col-sm-8">
                <input id="product_unit" name="product_unit" class="form-control" type="text" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><span class="span-red">*</span>报销金额(元)：</label>
            <div class="col-sm-8">
                <input id="product_unit" name="product_unit" class="form-control" type="text" />
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span class="span-red">*</span>费用说明：</label>
            <div class="col-sm-8">
